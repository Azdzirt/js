...
function  getFullName ({products, categories}) {
    return  ` $ { products }  $ { categories } ` ;
}

  
// var  fun = prompt("navprice(поиск по цене), navname(поиск по имени), prodend(добавить продукт в конец списка), чтобы выйти введите exit");
 
// function fu() {
 
//   if (fun = "navprice") navprice();
//   if (fun = "navname") navname({ prompt("введите название продукта");]);
//   if (fun = "prodend") prodend();
//   if (fun = "exit") break;
//   else alert("вы ввели не правильную команду");
// }
...
//   prompt("введите название продукта"); 
